...
const projectList = {
  splitIt : {
    ...
    "tech" : "<i class='devicon-rails-plain' id='project-icon'></i><i class='devicon-ruby-plain' id='project-icon'></i><i class='devicon-javascript-plain' id='project-icon'></i><i class='devicon-html5-plain' id='project-icon'></i><i class='devicon-sass-original' id='project-icon'></i><i class='devicon-heroku-original' id='project-icon'></i><i class='devicon-trello-plain' id='project-icon'></i><i class='devicon-figma-plain' id='project-icon'></i><i class='devicon-postgresql-plain' id='project-icon'></i><i class='devicon-github-original' id='project-icon'></i><i class='devicon-git-plain' id='project-icon'></i>",
